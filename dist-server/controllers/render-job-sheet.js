...
async function renderJobSheet({ domain: domainName, ganNo }) {
    ...
    const data = {
        ...
        eta: datetime_util_1.DateTimeConverter.date(foundGAN.etaDate),
        ata: ((_d = foundGAN) === null || _d === void 0 ? void 0 : _d.ata) ? datetime_util_1.DateTimeConverter.date(foundGAN.ata) : null,
        unloading_date: ((_e = foundWS) === null || _e === void 0 ? void 0 : _e.startedAt) ? datetime_util_1.DateTimeConverter.date(foundWS.startedAt) : '',
        mt_date: ((_f = foundJS) === null || _f === void 0 ? void 0 : _f.containerMtDate) ? datetime_util_1.DateTimeConverter.date(foundJS.containerMtDate) : '',
        advise_mt_date: datetime_util_1.DateTimeConverter.date(foundJS.adviseMtDate),
